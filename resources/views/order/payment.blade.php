        ...
        <section id="payment-details"
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="font-bold text-[#FF1943]">- Rp
                    {{ number_format($orderData['discount'], 0, ',', '.') }}</p>
            </div>
            <div class="flex items-center justify-between">
        ...
        <section id="send-payment-to"
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-[2px]">
                    <p class="font-semibold flex items-center">PahriStore <img
            ...
            <div class="flex items-center gap-[10px]">
                <img src="{{ asset('assets/images/icons/shield-tick.svg') }}" class="w-8 h-8 flex shrink-0"
                    alt="icon">
                <p class="leading-[26px]">Kami melindungi data privasi anda dengan baik bantuan Mon Amouur.</p>
            </div>
        </section>
